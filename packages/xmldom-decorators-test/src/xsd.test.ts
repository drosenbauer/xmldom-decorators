import { SchemaMapper } from '@drosenbauer/xmldom-decorators-cli/lib/schemascanner';
import { Schema, Element, ComplexType, ComplexContent, ComplexContentExtension, Sequence } from '@drosenbauer/xmldom-decorators-cli/lib/xsdschema';
